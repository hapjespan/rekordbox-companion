...
def create_app() -> FastAPI:
    ...
    # API routers (T015+) must be included above this line: Starlette
    # matches routes in registration order, and a Mount("/") matches any
    # path under it, so mounting the SPA first would swallow /api/... too.
    if WEB_DIST.is_dir():
